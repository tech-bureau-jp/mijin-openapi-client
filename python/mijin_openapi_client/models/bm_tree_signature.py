...
class BmTreeSignature(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "root": ParentPublicKeySignaturePair.from_dict(obj["root"]) if obj.get("root") is not None else None,
            "bottom": ParentPublicKeySignaturePair.from_dict(obj["bottom"]) if obj.get("bottom") is not None else None
        })
        return _obj
