...
class EmbeddedTransactionInfoDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "meta": EmbeddedTransactionMetaDTO.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "transaction": EmbeddedTransactionInfoDTOTransaction.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None
        })
        return _obj
