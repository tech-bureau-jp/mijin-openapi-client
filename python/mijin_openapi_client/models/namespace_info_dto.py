...
class NamespaceInfoDTO(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "meta": NamespaceMetaDTO.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "namespace": NamespaceDTO.from_dict(obj["namespace"]) if obj.get("namespace") is not None else None
        })
        return _obj
