...
class AggregateTransactionBodyExtendedDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.cosignatures:
            for _item_cosignatures in self.cosignatures:
                if _item_cosignatures:
                    _items.append(_item_cosignatures.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cosignatures": [CosignatureDTO.from_dict(_item) for _item in obj["cosignatures"]] if obj.get("cosignatures") is not None else None,
            "transactions": [EmbeddedTransactionInfoDTO.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
