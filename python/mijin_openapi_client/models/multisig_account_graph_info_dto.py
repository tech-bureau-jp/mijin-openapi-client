...
class MultisigAccountGraphInfoDTO(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.multisig_entries:
            for _item_multisig_entries in self.multisig_entries:
                if _item_multisig_entries:
                    _items.append(_item_multisig_entries.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "level": obj.get("level"),
            "multisigEntries": [MultisigAccountInfoDTO.from_dict(_item) for _item in obj["multisigEntries"]] if obj.get("multisigEntries") is not None else None
        })
        return _obj
