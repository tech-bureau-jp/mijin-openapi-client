...
class TransactionInfoDTOMeta(BaseModel):
    ...
    any_of_schemas: Set[str] = { "EmbeddedTransactionMetaDTO", "TransactionMetaDTO" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], EmbeddedTransactionMetaDTO, TransactionMetaDTO]]:
